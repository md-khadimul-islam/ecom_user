...
mixin _$CartModel {
  ...
  set productImage(String value) => throw _privateConstructorUsedError;
...
class _$CartModelImpl implements _CartModel {
  ...
  @override
  String toString() {
    return 'CartModel(productId: $productId, productName: $productName, productImage: $productImage, price: $price, quantity: $quantity)';
  }
